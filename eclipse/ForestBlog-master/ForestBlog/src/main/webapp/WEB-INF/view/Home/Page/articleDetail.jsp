...
<rapid:override name="header-style">
    <rapid:override name="header-style">
        <link rel="stylesheet" href="/resource/assets/css/highlight.css">
        <style>
            .entry-title {
                background: #f8f8f8;
            }
                ...
                <div class="entry-content">
                    ...
                    <div class="s-weixin">
                        <ul class="weimg1">
                            ...
                            <li>赶快加我聊天吧</li>
                            <li><img src="/resource/assets/img/weixin.jpg"></li>
                        </ul>
                        <ul class="weimg2">
                            <li><strong>博客交流群</strong></li>
                            <li>海纳百川，大家来水</li>
                            <li><img src="/resource/assets/img/qqGroup.jpg" alt="weinxin"></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                ...
                <div id="respond" class="comment-respond">
                    <h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">发表评论</span>
                        ...
                        <c:if test="${sessionScope.user == null}">
                            <span style="color:red">您未登录，登录后才能评论，<a href="/login"
                                                                               target="_blank">前往登录</a></span>
                        </c:if>
                    </h3>
